		...
		<div class="col-xl">
			<div class="card mb-4">
				<div class="card-header d-flex justify-content-between align-items-center">
					<h5 class="mb-0">Edit Operasional</h5>
				</div>
				<div class="card-body">
					<form action="" method="POST" enctype="multipart/form-data">
						<div class="form-floating form-floating-outline mb-4">
							<input type="datetime-local" class="form-control" name="tgl" id="basic-default-fullname"
								value="<?= $Operasional['tanggal_pengeluaran'] ?>" placeholder="Masukkan tanggal pengeluaran" />
						...
						<div class="form-floating form-floating-outline mb-4">
							<textarea type="text" class="form-control" name="keterangan" id="basic-default-company"
								placeholder="Masukkan keterangan"><?= $Operasional['keterangan'] ?></textarea>
						...
						<div class="form-floating form-floating-outline mb-4">
							<input type="text" id="basic-default-phone" name="harga" class="form-control phone-mask"
								value="<?= $Operasional['harga'] ?>" placeholder="Masukkan Harga" />
