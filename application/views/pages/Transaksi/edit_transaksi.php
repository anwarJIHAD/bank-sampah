<div class="container-xxl flex-grow-1 container-p-y">
	<h4 class="fw-bold py-3 mb-4"> <a class="text-muted fw-light" href="<?= base_url('C_Transaksi') ?>">Transaksi/</a><a
			class="text-muted fw-light" href="<?= base_url('C_Transaksi/detail/') . $Transaksi['id_nasabah'] ?>">Detail
			Transaksi
			Nasabah/</a><a class="text-muted fw-light"
			href="<?= base_url('C_Transaksi/detail2/') . $Transaksi['id_nasabah'] . '/' . $Transaksi['tanggal_transaksi'] ?>">Detail
			Per
			Transaksi/</a>
		Edit Per Transaksi</h4>
	<!-- Basic Layout -->
	<div class="row">
		<div class="col-xl">
			<div class="card mb-4">
