<div class="container-xxl flex-grow-1 container-p-y">
	<h4 class="fw-bold py-3 mb-4"> <a class="text-muted fw-light" href="<?= base_url('C_Transaksi') ?>">Transaksi/</a><a
			class="text-muted fw-light" href="<?= base_url('C_Transaksi/detail/' . $id_nasabah) ?>">Detail/</a>
		Tambah</h4>
	<!-- Basic Layout -->
	<div class="row">
		<div class="col-xl">
					...
					<form action="" method="POST" enctype="multipart/form-data">
						<div class="form-floating form-floating-outline mb-4">
							...
							<input type="text" class="form-control" name="nama" id="basic-default-company"
								value="<?= $nasabah['nama'] ?>" placeholder="Masukkan harga nasabah" readonly />
							<label for="basic-default-company">Nama Nasabah</label>
						</div>
						<div class="form-floating form-floating-outline mb-4">
						...
						<div class="form-floating form-floating-outline mb-4">
							...
							<label for="basic-default-phone inputrow">Total pendapatan</label>
						</div>
	...
	function tambah_baris() {
		let temp_html = `<div class="row col-sm-12 ml-4" style="margin-top:20px; ">
									<div class="form-group row col-sm-1"
										...
										<div class="col-sm-2">
											<input type="text" class="form-control harga" id="harga" name="harga[]"
												value="<?= set_value('harga[]'); ?>" placeholder="Harga" readonly>
										</div>
										<label for="inputdaerah" class="col-sm col-form-label inputrow"
											style="margin-right:-70px;">Total</label>
										<div class="col-sm-2">
