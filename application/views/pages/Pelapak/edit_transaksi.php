<div class="container-xxl flex-grow-1 container-p-y">
	<h4 class="fw-bold py-3 mb-4"> <a class="text-muted fw-light" href="<?= base_url('C_Penjualan') ?>">Penjualan
			...
			href="<?= base_url('C_Penjualan/detail/') . $Transaksi['id_pelapak']; ?>">Detail
			Penjualan/</a><a class="text-muted fw-light"
			href="<?= base_url('C_Penjualan/detail2/') . $Transaksi['id_pelapak'] . '/' . $Transaksi['tanggal_transaksi'] ?>">Detail
			Transaksi/</a>
		Edit Transaksi</h4>
	<!-- Basic Layout -->
	<div class="row">
			...
			<div class="card mb-4">
				...
				<div class="card-body">
					<form action="" method="POST" enctype="multipart/form-data">
						...
						<input type="hidden" name="id_pelapak" id="" value="<?= $Transaksi['id_pelapak']; ?>">
