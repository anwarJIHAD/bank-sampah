...
<div class="container-xxl flex-grow-1 container-p-y">
	<h4 class="py-1 mb-3"><span class="text-muted fw-light"></span> Penjualan Pelapak</h4>
	<div class="card">
		<div class="row">

		</div>
		<div class="d-flex align-items-center justify-content-between">
			<h5 class="card-header">Halaman Penjualan Pelapak</h5>
			<div class="card-header d-flex flex-row justify-content-end gap-3">
				...
				<a href="<?= base_url('C_Penjualan/tambah_pelapak') ?>" class="btn btn-primary">
					<i class="menu-icon tf-icons mdi mdi-plus"></i>
					<div style="font-size:10px;">Tambah Pelapak</div>
				</a>
...
<script>
	$(document).ready(function () {
		...
		function load_data(query) {
			$.ajax({
				url: "<?= base_url(); ?>C_Penjualan/fetch",
				method: "POST",
				data: {
					query: query
				},
