...
<div class="container-xxl flex-grow-1 container-p-y">
	...
	<div class="card">
		...
		<h5 class="card-header">Halaman Detail Transaksi pelapak
			<h6 style="margin-left:20px;">Nama pelapak :
				<?= $pelapak['nama'] ?>
			</h6>
			<h6 style="margin-left:20px;">Tanggal Transaksi :
				<?= $transaksi[0]['tanggal_transaksi'] ?>
			</h6>
		</h5>
...
<script>
	$(document).ready(function () {
		...
		function load_data(query) {
			$.ajax({
				url: "<?= base_url(); ?>C_Penjualan/fetch_detail2/" + <?= $id_pelapak ?>,
				method: "POST",
				data: {
					query: query,
